  ...
  return (
    ...
    >
        ...
        <div className="p-3.5 sm:p-4 relative flex-1 w-full overflow-hidden flex items-stretch gap-2.5 sm:gap-3 bg-white">
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  animate ? 'creategame02-media-populated' : 'opacity-100 scale-100'
                )}
              >
            ...
            >
              <p
                className={cn(
                  ...
                  animate ? 'creategame02-text-populated' : 'opacity-100'
                )}
              >
          ...
          <div
            className={cn(
              ...
              animate && 'creategame02-cursor-path'
            )}
            aria-hidden="true"
          >
            <svg
      ...
      <style>{`
        ...
        @keyframes kf_creategame02_media_box {
          0%, 25.9% {
        ...
        @keyframes kf_creategame02_media_pop {
          0%, 25.9% {
            opacity: 0;
            transform: scale(0.5);
          }
        ...
        @keyframes kf_creategame02_text_box {
          0%, 51.9% {
            background-color: #F2F2F2;
            border: 1px solid transparent;
            box-shadow: 0 0 0 0 rgba(205, 232, 62, 0);
        ...
        @keyframes kf_creategame02_text_pop {
          0%, 51.9% {
            opacity: 0;
        ...
        .creategame02-cursor-path {
          animation: kf_creategame02_cursor 4.5s infinite;
          will-change: transform;
        }

        .creategame02-media-container {
          animation: kf_creategame02_media_box 4.5s infinite;
          will-change: border-color, box-shadow;
        }

        .creategame02-media-populated {
          animation: kf_creategame02_media_pop 4.5s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }

        .creategame02-text-container {
          animation: kf_creategame02_text_box 4.5s infinite;
          will-change: border-color, box-shadow;
        }

        .creategame02-text-populated {
          animation: kf_creategame02_text_pop 4.5s ease-out infinite;
          will-change: transform, opacity;
        }
