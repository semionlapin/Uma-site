...
export interface CreateGame02Props extends React.HTMLAttributes<HTMLDivElement> {
  /**
...
export const CreateGame02: React.FC<CreateGame02Props> = ({
  className,
  ...
  return (
    ...
    >
        ...
        <div className="p-3.5 sm:p-4 relative flex-1 w-full overflow-hidden flex items-stretch gap-2.5 sm:gap-3 bg-white">
          ...
          <div
            className={cn(
              ...
              animate && 'creategame02-editor-fade'
            )}
          >
            {/* Left Sidebar Panel */}
              ...
              >
                ...
                <p
                  className={cn(
                    ...
                    animate && 'creategame02-typewriter-text'
                  )}
                >
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    animate && 'creategame02-child-flower'
                  )}
                >
      ...
      <style>{`
        ...
        @keyframes kf_creategame02_editor_fade {
          0% {
            opacity: 0;
        ...
        @keyframes kf_creategame02_cursor {
          0%, 22% {
        ...
        @keyframes kf_creategame02_child_flower {
          0%, 31.9% {
            opacity: 0;
            transform: scale(0.6);
          }
        ...
        @keyframes kf_creategame02_dropzone {
          0%, 46.9% {
        ...
        @keyframes kf_creategame02_docked_flower {
          0%, 46.9% {
            opacity: 0;
            transform: scale(0.5);
          }
        ...
        @keyframes kf_creategame02_textarea {
          0%, 53.9% {
            background-color: #F2F2F2;
            border-color: transparent;
            transform: scale(1);
        ...
        @keyframes kf_creategame02_typewriter {
          0%, 55.9% {
            opacity: 0;
        ...
        .creategame02-editor-fade {
          animation: kf_creategame02_editor_fade 5.2s ease-in-out infinite;
          will-change: transform, opacity;
        }

        .creategame02-cursor {
          animation: kf_creategame02_cursor 5.2s infinite;
          will-change: transform, opacity;
        }

        .creategame02-child-flower {
          animation: kf_creategame02_child_flower 5.2s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }

        .creategame02-dropzone {
          animation: kf_creategame02_dropzone 5.2s infinite;
          will-change: background-color, border-color;
        }

        .creategame02-docked-flower {
          animation: kf_creategame02_docked_flower 5.2s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }

        .creategame02-textarea {
          animation: kf_creategame02_textarea 5.2s infinite;
          will-change: transform, background-color, border-color;
        }

        .creategame02-typewriter-text {
          animation: kf_creategame02_typewriter 5.2s steps(28, end) infinite;
