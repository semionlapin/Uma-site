...
export interface CreateGame01Props extends React.HTMLAttributes<HTMLDivElement> {
  /**
...
export const CreateGame01: React.FC<CreateGame01Props> = ({
  className,
