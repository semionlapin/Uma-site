  ...
  return (
    ...
    >
        ...
        <div className="p-3.5 sm:p-4 relative flex-1 w-full overflow-hidden bg-white flex flex-col justify-center items-center">
          ...
          <div
            className={cn(
              ...
              animate ? 'generategame03-share-input-stage' : 'hidden'
            )}
          >
            <div className="w-full max-w-[390px] px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-full border border-[#C4C4C4] bg-white shadow-md flex items-center gap-3">
              ...
              <div className="size-9 sm:size-10 rounded-full bg-[#F6FDCF] border border-[#CDE83E] flex items-center justify-center shrink-0">
                <svg
                  className={cn(
                    'w-5 h-4 text-[#576501]',
                    animate && 'generategame03-checkmark-svg'
                  )}
                  viewBox="0 0 29 23"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className={cn(
              ...
              animate && 'generategame03-cursor-sequence'
            )}
            aria-hidden="true"
          >
            <svg
      ...
      <style>{`
        ...
        @keyframes kf_generategame03_editor_view {
          0%, 23.9% {
            opacity: 1;
            transform: scale(1);
            pointer-events: auto;
        ...
        @keyframes kf_generategame03_share_input {
          0%, 23.9% {
            opacity: 0;
        ...
        @keyframes kf_generategame03_checkmark {
          0%, 23.9% {
            opacity: 0;
            transform: scale(0);
          }
        ...
        .generategame03-cursor-sequence {
          animation: kf_generategame03_cursor 4.0s infinite;
          will-change: transform;
        }

        .generategame03-publish-btn {
          animation: kf_generategame03_publish_btn 4.0s infinite;
          will-change: transform, background-color;
        }

        .generategame03-editor-view {
          animation: kf_generategame03_editor_view 4.0s ease-in-out infinite;
          will-change: transform, opacity;
        }

        .generategame03-share-input-stage {
          animation: kf_generategame03_share_input 4.0s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame03-checkmark-svg {
          animation: kf_generategame03_checkmark 4.0s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }
