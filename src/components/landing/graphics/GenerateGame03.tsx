...
export interface GenerateGame03Props extends React.HTMLAttributes<HTMLDivElement> {
  /**
...
export const GenerateGame03: React.FC<GenerateGame03Props> = ({
  className,
    ...
    >
      ...
      <div className="w-full max-w-none aspect-[16/10] bg-white rounded-[16px] shadow-sm border border-border-neutral-subtle/60 flex flex-col overflow-hidden relative">
        ...
        <div className="relative flex-1 w-full overflow-hidden bg-white">
          {/* VIEW 1: Pre-Populated AI Generated Editor Screen (Matching GenerateGame02 End-State) */}
          <div
            className={cn(
              'absolute inset-0 p-3.5 sm:p-4 flex items-stretch gap-2.5 sm:gap-3 transition-all duration-300',
              animate && 'generategame03-view1'
            )}
          >
            {/* Left Sidebar Panel */}
              ...
              <div className="w-full relative">
                <div
                  className={cn(
                    ...
                    animate && 'generategame03-publish-btn'
                  )}
                >
            ...
            {/* Right Editor Canvas (Fully Populated matching GenerateGame02) */}
            <div className="flex-1 h-full bg-[#F8F8F8] rounded-[8px] p-3 sm:p-4 flex flex-col items-center justify-center gap-3 relative overflow-hidden border border-border-neutral-subtle/40">
              {/* TOP: Image Card (Selected Lime State) */}
              ...
              {/* BOTTOM: Text Description Area with Magic Wand Button (Selected Soft Lime State) */}
              <div className="w-full max-w-[280px] h-[95px] p-2.5 rounded-[8px] flex flex-col justify-start relative overflow-hidden bg-[#DCF652]/20 border-[1.5px] border-[#9EBF00]">
                <p className="text-[9px] sm:text-[10px] font-body leading-relaxed text-[#576501] pr-7">
                ...
                <div className="absolute right-2 bottom-2 size-[26px] rounded-full bg-[#DCF652] border border-[#9EBF00] flex items-center justify-center shadow-xs">
                  <Wand2 className="size-3.5 text-[#576501]" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            className={cn(
              ...
              animate ? 'generategame03-view2' : 'hidden'
            )}
          >
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-3 w-full">
                ...
                <div
                  className={cn(
                    ...
                    animate && 'generategame03-new-card'
                  )}
                >
      ...
      <style>{`
        ...
        @keyframes kf_generategame03_view1 {
          0% {
            opacity: 0;
        ...
        /* Cursor: 0-24% rests idle near wand button -> 24-35% glides to Publish button -> click impact -> fade out */
        @keyframes kf_generategame03_cursor {
          0%, 24% {
            /* Resting idle down in bottom-right area next to wand (matching GenerateGame02 end state) */
            transform: translate(300px, -80px) scale(1);
            opacity: 1;
          }
          35% {
            /* Glides smoothly across canvas and lands dead-center on bottom Publish button */
        ...
        @keyframes kf_generategame03_publish_btn {
          0%, 34.9% {
        ...
        @keyframes kf_generategame03_view2 {
          0%, 42% {
            opacity: 0;
            transform: scale(0.98);
            pointer-events: none;
        ...
        @keyframes kf_generategame03_new_card {
          0%, 47.9% {
            opacity: 0;
            transform: scale(0);
          }
        ...
        .generategame03-view1 {
          animation: kf_generategame03_view1 5.5s ease-in-out infinite;
          will-change: transform, opacity;
        }

        .generategame03-cursor {
          animation: kf_generategame03_cursor 5.5s infinite;
          will-change: transform, opacity;
        }

        .generategame03-publish-btn {
          animation: kf_generategame03_publish_btn 5.5s infinite;
          will-change: transform, background-color, border-color;
        }

        .generategame03-view2 {
          animation: kf_generategame03_view2 5.5s ease-in-out infinite;
          will-change: transform, opacity;
        }

        .generategame03-new-card {
          animation: kf_generategame03_new_card 5.5s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }
