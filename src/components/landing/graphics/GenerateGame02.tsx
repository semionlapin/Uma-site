    ...
    >
      ...
      <div className="w-full max-w-none aspect-[16/10] bg-white rounded-[16px] shadow-sm border border-border-neutral-subtle/60 flex flex-col overflow-hidden relative">
        ...
        <div className="p-3.5 sm:p-4 relative flex-1 w-full overflow-hidden flex items-stretch gap-2.5 sm:gap-3 bg-white">
          ...
          {/* Right Editor Canvas Canvas Area */}
          <div className="flex-1 h-full bg-[#F8F8F8] rounded-[8px] p-3 sm:p-4 flex flex-col items-center justify-center gap-3 relative overflow-hidden border border-border-neutral-subtle/40">
            ...
            >
              ...
              >
                <SparkleStar size={18} fill="#CDE83E" />
              </div>
              <div
                className={cn(
              ...
              >
                <SparkleStar size={14} fill="#B5D324" />
              </div>
            </div>
            ...
            >
              ...
              <div
                className={cn(
                  'absolute right-2 bottom-2 size-[29px] rounded-full bg-[#CDE83E] border border-[#B8D430] flex items-center justify-center shadow-xs cursor-pointer z-10',
              ...
              >
                <SparkleStar size={20} fill="#CDE83E" />
              </div>
              <div
                className={cn(
              ...
              >
                <SparkleStar size={12} fill="#9AB314" />
              </div>
              <div
                className={cn(
      ...
      <style>{`
        /* STEP 1 & 2: Cursor glides toward Magic Wand button -> Clicks -> Slides aside -> Resets */
        @keyframes kf_generategame02_cursor {
          0% {
            /* Initial resting offset on left */
          ...
          27% {
            ...
            transform: translate(242px, 158px) scale(0.85);
          }
          31% {
            /* Click release */
            transform: translate(242px, 158px) scale(1);
        ...
        @keyframes kf_generategame02_magic_btn {
          ...
          27% {
            ...
            box-shadow: 0 0 14px 3px rgba(205, 232, 62, 0.8);
          }
          31% {
            transform: scale(1.12);
            box-shadow: 0 0 18px 5px rgba(205, 232, 62, 0.6);
          }
          35%, 85% {
            transform: scale(1);
            box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);
        ...
        /* STEP 3: Magic Stars bursting around button upon click */
        ...
        /* STEP 3: Magic Stars bursting around top media card */
        ...
        /* STEP 4: Top Media Card border styling */
        ...
        /* STEP 4: Top Media populates smoothly */
        ...
        /* STEP 4: Bottom Text Container border styling */
        ...
        /* STEP 4: Bottom Text populates smoothly */
        ...
        .generategame02-cursor-path {
          animation: kf_generategame02_cursor 4.5s infinite;
          will-change: transform;
        }

        .generategame02-magic-btn {
          animation: kf_generategame02_magic_btn 4.5s infinite;
          will-change: transform, box-shadow;
        }

        .generategame02-star-cluster-btn {
          animation: kf_generategame02_stars_btn 4.5s cubic-bezier(0.2, 0.8, 0.4, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-star-cluster-btn-sub {
          animation: kf_generategame02_stars_btn_sub 4.5s cubic-bezier(0.2, 0.8, 0.4, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-star-cluster-btn-low {
          animation: kf_generategame02_stars_btn_low 4.5s cubic-bezier(0.2, 0.8, 0.4, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-star-cluster-top {
          animation: kf_generategame02_stars_top 4.5s cubic-bezier(0.2, 0.8, 0.4, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-star-cluster-top-left {
          animation: kf_generategame02_stars_top_left 4.5s cubic-bezier(0.2, 0.8, 0.4, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-media-box {
          animation: kf_generategame02_media_box 4.5s infinite;
          will-change: border-color, box-shadow;
        }

        .generategame02-media-pop {
          animation: kf_generategame02_media_pop 4.5s cubic-bezier(0.34, 1.56, 0.64, 1) infinite;
          will-change: transform, opacity;
        }

        .generategame02-text-box {
          animation: kf_generategame02_text_box 4.5s infinite;
          will-change: border-color, box-shadow;
        }

        .generategame02-text-pop {
          animation: kf_generategame02_text_pop 4.5s ease-out infinite;
          will-change: transform, opacity;
        }
