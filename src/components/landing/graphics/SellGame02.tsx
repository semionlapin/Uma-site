...
export interface SellGame02Props extends React.HTMLAttributes<HTMLDivElement> {
  /**
...
export const SellGame02: React.FC<SellGame02Props> = ({
  className,
  ...
  return (
    ...
    >
        ...
        <div className="p-4 sm:p-5 relative flex-1 w-full overflow-hidden flex flex-col justify-start items-center bg-white">
          ...
          <div
            className={cn(
              ...
              animate && 'sellgame02-grid-scroll'
            )}
          >
            {/* Row 1 */}
          ...
          <div
            className={cn(
              ...
              animate && 'sellgame02-cursor-motion'
            )}
            aria-hidden="true"
          >
            <svg
      ...
      <style>{`
        ...
        @keyframes kf_sellgame02_grid_scroll {
          0%, 20% {
        ...
        @keyframes kf_sellgame02_cursor {
          0%, 20% {
        ...
        @keyframes kf_sellgame02_card_select {
          0%, 58% {
        ...
        @keyframes kf_sellgame02_icon_box {
          0%, 64% {
        ...
        .sellgame02-grid-scroll {
          animation: kf_sellgame02_grid_scroll 4.5s infinite;
          will-change: transform;
        }

        .sellgame02-cursor-motion {
          animation: kf_sellgame02_cursor 4.5s infinite;
          will-change: transform;
        }

        .sellgame02-target-card {
          animation: kf_sellgame02_card_select 4.5s infinite;
          will-change: transform, border-color, background-color;
        }

        .sellgame02-target-icon-box {
          animation: kf_sellgame02_icon_box 4.5s infinite;
          will-change: background-color;
        }

        .sellgame02-target-icon {
          animation: kf_sellgame02_icon 4.5s infinite;
          will-change: color;
        }

        .sellgame02-target-bar-1 {
          animation: kf_sellgame02_bar_1 4.5s infinite;
          will-change: background-color;
        }

        .sellgame02-target-bar-2 {
          animation: kf_sellgame02_bar_2 4.5s infinite;
          will-change: background-color;
        }
